...
O comando `auditoria-higiene install` MUST configurar um repositório Python GitHub com configuração e workflow necessários, sem sobrescrever arquivos existentes sem confirmação explícita.
...
- **WHEN** o desenvolvedor executa `auditoria-higiene install --dry-run`
